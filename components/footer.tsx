...
export async function Footer() {
  ...
  return (
    <footer className="bg-navy border-t border-white/6 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-10 mb-12">
          ...
          <div className="col-span-2 md:col-span-1">
            <Link href="/" className="inline-flex items-center gap-2.5 mb-4">
              <div
                className="w-4 h-4 bg-gold shrink-0"
                style={{ clipPath: "polygon(50% 0%, 100% 25%, 100% 75%, 50% 100%, 0% 75%, 0% 25%)" }}
              />
              <span className="font-display font-black text-white text-xs tracking-[0.18em] uppercase">
                The League
              </span>
            </Link>
            <p className="text-white/25 text-[13px] leading-relaxed max-w-[200px]">
          ...
          {/* Competition */}
          <div>
            <p className="text-[9px] font-bold uppercase tracking-[0.5em] text-dim mb-4">Competition</p>
          ...
          {/* Community */}
          <div>
            <p className="text-[9px] font-bold uppercase tracking-[0.5em] text-dim mb-4">Community</p>
            <ul className="space-y-2.5">
              {[
                ["Clubs",    "/clubs"],
                ["Players",  "/players"],
          ...
          {/* Organisation */}
          <div>
            <p className="text-[9px] font-bold uppercase tracking-[0.5em] text-dim mb-4">Organisation</p>
            <ul className="space-y-2.5">
              {[
                ["Sponsors",      "/sponsors"],
        ...
        <div className="border-t border-white/6 pt-6 flex flex-col sm:flex-row items-center justify-between gap-2">
          ...
          <p className="text-[11px] text-white/15 uppercase tracking-[0.25em]">Season 1</p>
        </div>
      </div>
    </footer>
  );
